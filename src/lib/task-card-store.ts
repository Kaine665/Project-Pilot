 ...
 *   ~/.project-pilot/data/chat/messages/{sessionId}.task-card.json
 *
 * The card is generated by the task-card-generation satellite task
 * after each agent reply, using incremental updates.
 */
