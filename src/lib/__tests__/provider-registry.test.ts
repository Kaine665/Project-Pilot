...
// --- 1. Registry loaded ---
assert(PROVIDER_REGISTRY.length >= 10, `At least 10 providers loaded (got ${PROVIDER_REGISTRY.length})`);
...
assert(getModelContextWindow('MiniMax-M2.5') === 1000000, 'MiniMax = 1M');
// Prefix fallback
