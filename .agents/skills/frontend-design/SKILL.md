...
metadata:
  upstream: https://github.com/EveryInc/compound-engineering-plugin/tree/main/plugins/compound-engineering/skills/frontend-design
  upstreamFile: https://raw.githubusercontent.com/EveryInc/compound-engineering-plugin/main/plugins/compound-engineering/skills/frontend-design/SKILL.md
  vendorNote: Vendored for Cursor / Agent Skills; periodically diff against upstream SKILL.md.
  vendoredAt: '2026-04-09'
---
...
For iterative refinement beyond a single pass (multiple rounds of screenshot-assess-fix), see the `compound-engineering:design:design-iterator` agent in the upstream Compound Engineering plugin (separate from this vendored skill file).
